...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0xCB, 42, {0x7C,0x69,0x5D,0x49,0x3C,0x36,0x27,0x2C,0x19,0x37,0x39,0x3C,0x5B,0x49,0x4F,0x43,0x42,0x32,0x25,0x1A,0x06,0x7C,0x69,0x5D,0x49,0x3C,0x36,0x27,0x2C,0x19,0x37,0x39,0x3C,0x5B,0x49,0x4F,0x43,0x42,0x32,0x25,0x1A,0x06}},
...
{
	LCM_LOGI("%s,jd9365t_hy_mdt backlight: level = %d\n", __func__, level);

	if (level == 0) {
		pr_notice("[LCM],jd9365t_hy_mdt backlight off, diming disable first\n");
		push_table(NULL,
...
struct LCM_DRIVER jd9365t_hdplus1600_dsi_vdo_hy_mdt_lcm_drv = {
	.name = "jd9365t_hdplus1600_dsi_vdo_hy_mdt",
