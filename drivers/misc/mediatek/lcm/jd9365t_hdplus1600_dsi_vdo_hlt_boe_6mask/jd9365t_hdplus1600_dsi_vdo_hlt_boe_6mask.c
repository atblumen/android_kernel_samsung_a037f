...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0xC0, 5, {0x00,0xDD,0x1A,0xDD,0x1A}},

	{0xCB, 42, {0x6C,0x63,0x5B,0x50,0x46,0x42,0x34,0x38,0x20,0x37,0x33,0x2F,0x48,0x31,0x34,0x24,0x1F,0x13,0x06,0x02,0x00,0x6C,0x63,0x5B,0x50,0x46,0x42,0x34,0x38,0x20,0x37,0x33,0x2F,0x48,0x31,0x34,0x24,0x1F,0x13,0x06,0x02,0x00}},
...
{
	LCM_LOGI("%s,jd9365t_hlt_boe backlight: level = %d\n", __func__, level);

	if (level == 0) {
		pr_notice("[LCM],jd9365t_hlt_boe backlight off, diming disable first\n");
		push_table(NULL,
...
struct LCM_DRIVER jd9365t_hdplus1600_dsi_vdo_hlt_boe_6mask_lcm_drv = {
	.name = "jd9365t_hdplus1600_dsi_vdo_hlt_boe_6mask",
